...
type SyncResult struct {
	...
	Synced *struct {
		...
		Rosters *int `json:"rosters,omitempty"`
...
// PostV1LineupRecommendJSONBody defines parameters for PostV1LineupRecommend.
type PostV1LineupRecommendJSONBody struct {
	TeamId string `json:"team_id"`
	Week   *int   `json:"week,omitempty"`
}
...
// PostV1LineupRecommendJSONRequestBody defines body for PostV1LineupRecommend for application/json ContentType.
type PostV1LineupRecommendJSONRequestBody PostV1LineupRecommendJSONBody
...
type ClientInterface interface {
	...
	// PostV1LineupRecommendWithBody request with any body
	PostV1LineupRecommendWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostV1LineupRecommend(ctx context.Context, body PostV1LineupRecommendJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetV1MeTeam request
	GetV1MeTeam(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// GetV1SyncEspnCheck request
	GetV1SyncEspnCheck(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PostV1SyncEspnDelta request
	PostV1SyncEspnDelta(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PostV1SyncEspnFull request
	PostV1SyncEspnFull(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) PostV1LineupRecommendWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostV1LineupRecommendRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PostV1LineupRecommend(ctx context.Context, body PostV1LineupRecommendJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostV1LineupRecommendRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetV1MeTeam(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetV1MeTeamRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetV1SyncEspnCheck(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetV1SyncEspnCheckRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PostV1SyncEspnDelta(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostV1SyncEspnDeltaRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PostV1SyncEspnFull(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostV1SyncEspnFullRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewPostV1LineupRecommendRequest calls the generic PostV1LineupRecommend builder with application/json body
func NewPostV1LineupRecommendRequest(server string, body PostV1LineupRecommendJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewPostV1LineupRecommendRequestWithBody(server, "application/json", bodyReader)
}

// NewPostV1LineupRecommendRequestWithBody generates requests for PostV1LineupRecommend with any type of body
func NewPostV1LineupRecommendRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/lineup/recommend")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetV1MeTeamRequest generates requests for GetV1MeTeam
func NewGetV1MeTeamRequest(server string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/me/team")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetV1SyncEspnCheckRequest generates requests for GetV1SyncEspnCheck
func NewGetV1SyncEspnCheckRequest(server string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/sync/espn/check")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewPostV1SyncEspnDeltaRequest generates requests for PostV1SyncEspnDelta
func NewPostV1SyncEspnDeltaRequest(server string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/sync/espn/delta")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewPostV1SyncEspnFullRequest generates requests for PostV1SyncEspnFull
func NewPostV1SyncEspnFullRequest(server string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/sync/espn/full")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// PostV1LineupRecommendWithBodyWithResponse request with any body
	PostV1LineupRecommendWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostV1LineupRecommendResponse, error)

	PostV1LineupRecommendWithResponse(ctx context.Context, body PostV1LineupRecommendJSONRequestBody, reqEditors ...RequestEditorFn) (*PostV1LineupRecommendResponse, error)

	// GetV1MeTeamWithResponse request
	GetV1MeTeamWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetV1MeTeamResponse, error)
	...
	// GetV1SyncEspnCheckWithResponse request
	GetV1SyncEspnCheckWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetV1SyncEspnCheckResponse, error)

	// PostV1SyncEspnDeltaWithResponse request
	PostV1SyncEspnDeltaWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*PostV1SyncEspnDeltaResponse, error)

	// PostV1SyncEspnFullWithResponse request
	PostV1SyncEspnFullWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*PostV1SyncEspnFullResponse, error)
...
type PostV1LineupRecommendResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *struct {
		Bench    *[]map[string]interface{} `json:"bench,omitempty"`
		Starters *[]struct {
			Player    *Player          `json:"player,omitempty"`
			Slot      *string          `json:"slot,omitempty"`
			Valuation *PlayerValuation `json:"valuation,omitempty"`
		} `json:"starters,omitempty"`
		TotalVorp *float32 `json:"total_vorp,omitempty"`
	}
}

// Status returns HTTPResponse.Status
func (r PostV1LineupRecommendResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PostV1LineupRecommendResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetV1MeTeamResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *struct {
		LeagueId *int                  `json:"league_id,omitempty"`
		Source   *GetV1MeTeam200Source `json:"source,omitempty"`
		TeamId   *string               `json:"team_id,omitempty"`
		Year     *int                  `json:"year,omitempty"`
	}
	JSON404 *NotFound
}
type GetV1MeTeam200Source string

// Status returns HTTPResponse.Status
func (r GetV1MeTeamResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetV1MeTeamResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type GetV1SyncEspnCheckResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *struct {
		DetectedMyTeamId    *string `json:"detected_my_team_id"`
		LeagueId            *int    `json:"league_id,omitempty"`
		NeedsPrivateCookies *bool   `json:"needs_private_cookies,omitempty"`
		Ok                  *bool   `json:"ok,omitempty"`
		Teams               *[]struct {
			Id       *string   `json:"id,omitempty"`
			Name     *string   `json:"name,omitempty"`
...
// Status returns HTTPResponse.Status
func (r GetV1SyncEspnCheckResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetV1SyncEspnCheckResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type PostV1SyncEspnDeltaResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *SyncResult
	JSON400      *BadRequest
...
// Status returns HTTPResponse.Status
func (r PostV1SyncEspnDeltaResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PostV1SyncEspnDeltaResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type PostV1SyncEspnFullResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *SyncResult
	JSON400      *BadRequest
...
// Status returns HTTPResponse.Status
func (r PostV1SyncEspnFullResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PostV1SyncEspnFullResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// PostV1LineupRecommendWithBodyWithResponse request with arbitrary body returning *PostV1LineupRecommendResponse
func (c *ClientWithResponses) PostV1LineupRecommendWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostV1LineupRecommendResponse, error) {
	rsp, err := c.PostV1LineupRecommendWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostV1LineupRecommendResponse(rsp)
}

func (c *ClientWithResponses) PostV1LineupRecommendWithResponse(ctx context.Context, body PostV1LineupRecommendJSONRequestBody, reqEditors ...RequestEditorFn) (*PostV1LineupRecommendResponse, error) {
	rsp, err := c.PostV1LineupRecommend(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostV1LineupRecommendResponse(rsp)
...
// GetV1MeTeamWithResponse request returning *GetV1MeTeamResponse
func (c *ClientWithResponses) GetV1MeTeamWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetV1MeTeamResponse, error) {
	rsp, err := c.GetV1MeTeam(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetV1MeTeamResponse(rsp)
}
...
// GetV1SyncEspnCheckWithResponse request returning *GetV1SyncEspnCheckResponse
func (c *ClientWithResponses) GetV1SyncEspnCheckWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetV1SyncEspnCheckResponse, error) {
	rsp, err := c.GetV1SyncEspnCheck(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetV1SyncEspnCheckResponse(rsp)
}

// PostV1SyncEspnDeltaWithResponse request returning *PostV1SyncEspnDeltaResponse
func (c *ClientWithResponses) PostV1SyncEspnDeltaWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*PostV1SyncEspnDeltaResponse, error) {
	rsp, err := c.PostV1SyncEspnDelta(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostV1SyncEspnDeltaResponse(rsp)
}

// PostV1SyncEspnFullWithResponse request returning *PostV1SyncEspnFullResponse
func (c *ClientWithResponses) PostV1SyncEspnFullWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*PostV1SyncEspnFullResponse, error) {
	rsp, err := c.PostV1SyncEspnFull(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostV1SyncEspnFullResponse(rsp)
}
...
// ParsePostV1LineupRecommendResponse parses an HTTP response from a PostV1LineupRecommendWithResponse call
func ParsePostV1LineupRecommendResponse(rsp *http.Response) (*PostV1LineupRecommendResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PostV1LineupRecommendResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseGetV1MeTeamResponse parses an HTTP response from a GetV1MeTeamWithResponse call
func ParseGetV1MeTeamResponse(rsp *http.Response) (*GetV1MeTeamResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
// ParseGetV1SyncEspnCheckResponse parses an HTTP response from a GetV1SyncEspnCheckWithResponse call
func ParseGetV1SyncEspnCheckResponse(rsp *http.Response) (*GetV1SyncEspnCheckResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetV1SyncEspnCheckResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParsePostV1SyncEspnDeltaResponse parses an HTTP response from a PostV1SyncEspnDeltaWithResponse call
func ParsePostV1SyncEspnDeltaResponse(rsp *http.Response) (*PostV1SyncEspnDeltaResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PostV1SyncEspnDeltaResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParsePostV1SyncEspnFullResponse parses an HTTP response from a PostV1SyncEspnFullWithResponse call
func ParsePostV1SyncEspnFullResponse(rsp *http.Response) (*PostV1SyncEspnFullResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PostV1SyncEspnFullResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
